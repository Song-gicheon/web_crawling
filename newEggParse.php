...
//    $regex_item_name = '/<a.*?href="([^"]*)"[^>]*>(.*)<\/a>/'; 
    ...
    {
    	echo '<a '.$arr_data[$row]['path'].' target="_blank"><li class="prod_item"><div class="item_block"><div class="item_img"><img '.$arr_data[$row]['img'].' width="100%"></img></div><div class="item_title">'.$arr_data[$row]['prod'].'</div><div class="item_price">'.$arr_data[$row]['price'].'</div></div></li></a>';
    }
?>
